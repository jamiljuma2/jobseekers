...
export default async function CareerPassportPage() {
  ...
  const sections = [['Experience', experiences?.length ?? 0], ['Education', education?.length ?? 0], ['Skills', skills?.length ?? 0], ['Certifications', certifications?.length ?? 0], ['Projects', projects?.length ?? 0]];
